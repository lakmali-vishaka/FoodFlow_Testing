...
public class Check_required_fieleds {
    ...
    public void openUrl() throws InterruptedException {
        ...
        driver.get("https://ppt1001.github.io/TheFoodFlow/");
    ...
    //add product by leaving space
    
    @Test
    public void TC_01A() throws InterruptedException {
    	driver.findElement(By.id("productName")).sendKeys("");
    	driver.findElement(By.xpath("//option[@value='Pizza']")).click();
    	driver.findElement(By.id("productPrice")).sendKeys("67");
    ...
    public void TC_01B() throws InterruptedException {
    	driver.findElement(By.id("productName")).sendKeys("Pasta_noodles");
    	driver.findElement(By.xpath("//option[@value='Fried Rice']")).click();
    	driver.findElement(By.id("productPrice")).sendKeys("");
    	driver.findElement(By.id("quantity")).sendKeys("5");
    ...
    public void TC_01C() throws InterruptedException {
    	driver.findElement(By.id("productName")).sendKeys("vatalappan_milk");
    ...
    public void TC_02() throws InterruptedException {
    	driver.findElement(By.id("productName")).sendKeys("chocolate");
    	driver.findElement(By.xpath("//option[@value='Noodles']")).click();
    	driver.findElement(By.id("productPrice")).sendKeys("100");
    	driver.findElement(By.id("quantity")).sendKeys("5");
    ...
    //adding a product that already added
    
   @Test
    public void TC_03() throws InterruptedException {
    	driver.findElement(By.id("productName")).sendKeys("chocolate");
    	driver.findElement(By.xpath("//option[@value='String Hoppers']")).click();
    	driver.findElement(By.id("productPrice")).sendKeys("100");
    	driver.findElement(By.id("quantity")).sendKeys("5");
